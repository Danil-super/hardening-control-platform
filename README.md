...
Подключайте хосты под административной учётной записью: root с разрешённым SSH-входом или администратор с настроенным беспарольным sudo. Форма проверяет права root перед сохранением; отдельных переключателей sudo нет. [Требования к доступу](docs/ubuntu-astra-setup.md#sudo-access). Для уже добавленного хоста [измените существующую запись](docs/ubuntu-astra-setup.md#existing-host), сохранив историю.
