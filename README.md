...
Для целевой **Astra Linux 1.7.6.15** используйте [отдельную инструкцию](docs/astra-lab.md): она объясняет подготовку ВМ, проверку готовности в мастере и границы CVE/SCAP-поддержки. Автоматическое наследование поддержки Debian для Astra не применяется.
