...
- **Сетевая база** — нажмите «Сохранить и загрузить»; HCP скачает или обновит базу через публичный registry либо заданное внутреннее OCI-зеркало. При уже выбранном режиме используйте «Загрузить базу Trivy».
