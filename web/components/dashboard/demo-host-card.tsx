  ...
  return (
    <section className="rounded-md border border-sky-400/25 bg-slate-950/75 p-5 shadow-xl shadow-black/10">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <p className="text-xs font-semibold uppercase text-sky-200">Demo Host / Audit Source</p>
      ...
      <p className="mt-3 max-w-4xl text-sm leading-6 text-slate-300">
        ...
        Проверки берутся из локального mock-движка, поэтому сайт можно безопасно запускать на Vercel без root-доступа,
        системных команд и изменения реального сервера.
      </p>
