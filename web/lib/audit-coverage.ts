...
const knownChecks: Record<string, CheckDetails> = {
  ...
  firewall_active: {
    ...
    description: "Не удалось определить состояние поддерживаемого UFW или firewalld.",
    nextStep: "Убедитесь, что один из поддерживаемых firewall доступен с правами администратора, либо оцените nftables/iptables вручную, затем повторите аудит.",
  },
