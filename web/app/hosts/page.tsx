    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 max-w-3xl text-slate-400">
          Локальная панель для главного компьютера в сети: находите Linux-хосты, проверяйте их по SSH, запускайте
          безагентный аудит и применяйте response-playbook'и только после подтверждения администратора.
        </p>
      </div>
      ...
      <section className="grid gap-4 lg:grid-cols-3">
        ...
        <div className="rounded-md border border-slate-800 bg-slate-950/70 p-5">
          ...
          <h2 className="mt-3 text-lg font-semibold text-white">Проверить SSH-доступ</h2>
          <code className="mt-3 block rounded-md bg-slate-900 p-3 text-xs text-slate-200">
        ...
        <div className="rounded-md border border-slate-800 bg-slate-950/70 p-5">
          ...
          <h2 className="mt-3 text-lg font-semibold text-white">Запустить центр управления</h2>
          <code className="mt-3 block rounded-md bg-slate-900 p-3 text-xs text-slate-200">
